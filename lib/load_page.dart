...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    double batteryPercentageFontSize = screenWidth * 0.11;
    double batteryTextFontSize = screenWidth * 0.06;
    double vehicleIDFontSize = screenWidth * 0.04;
    double activeImageScale = screenWidth * 0.22; // Adjusted the image scale
